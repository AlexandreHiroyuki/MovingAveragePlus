// To include only ArithmeticMovingAverage use:
#include <ArithmeticMovingAverage.h>

// To include all libs use:
#include <MovingAverage.h>

// Create an Arithmetic Moving Average object of unsigned int type,
// 10 in size
// and initialize it with value 2
ArithmeticMA<unsigned> test(10, 2);
